...
$$.Closure$main = [A, {"": "Closure;call$0,$name", $is_void_: true}];

$$.Closure$reverseText = [A, {"": "Closure;call$1,$name"}];
...
["web_helloworld.dart", "web_helloworld.dart", , A, {
main: function() {
  var t1, t2;
  ...
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(A.reverseText$closure), t1._useCapture);
...
init.globalFunctions.main$closure = A.main$closure = new A.Closure$main(A.main, "main$closure");
init.globalFunctions.reverseText$closure = A.reverseText$closure = new A.Closure$reverseText(A.reverseText, "reverseText$closure");
